...
export const CLIMBING_CONFIG = Object.freeze({
  ...
  sameSurfaceBlockDuration: 0.3,
  sameSurfaceMinimumSeparation: 0.32,
  sameSurfaceClearSeparation: 0.78,
  sameSurfaceMinimumDistance: 0.48,
  sameSurfaceClearDistance: 0.88,
