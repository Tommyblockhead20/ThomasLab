...
const LEGACY_HABITATS = Object.freeze({
  ...
  "arctic-grayling": Object.freeze({"salinity":"fresh","tiers":["middle","upper","waterfall"],"waterTypes":["stream-pool","tarn","lake","waterfall-pool"],"themes":["fernwood","blackstone"],"strictWaterTypes":true,"preferredTheme":"blackstone","favoredWaterIds":["windcut-tarn"]}),
