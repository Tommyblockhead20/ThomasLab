...
export const TRAIL_BADGE_DEFINITIONS = Object.freeze([
  ...
  badge('seasoned-angler', 'Seasoned Angler', 'Land 100 catches.', 'totalCatches', 100),
  badge('thousand-casts', 'Thousand Catches', 'Land 1,000 catches.', 'totalCatches', 1000),
  badge('living-legend', 'Ten-Thousand Catches', 'Land 10,000 catches.', 'totalCatches', 10000),
  ...
  badge('biome-naturalist', 'Biome Naturalist', 'Catch a creature in every biome.', 'biomes', 1),
  badge('water-explorer-1', 'Water Explorer I', 'Catch a creature in 5 distinct waters.', 'waters', 5),
  badge('water-explorer-2', 'Water Explorer II', 'Catch a creature in 15 distinct waters.', 'waters', 15),
  badge('water-explorer-3', 'Water Explorer III', 'Catch a creature in every fishing water.', 'waters', 1),
  badge('first-ascent', 'First Ascent', 'Reach your first summit.', 'summits', 1),
  badge('summit-regular', 'Summit Regular', 'Complete 5 summit ascents.', 'summits', 5),
  badge('peak-veteran', 'Peak Veteran', 'Complete 20 summit ascents.', 'summits', 20),
  badge('island-hopper', 'Island Hopper', 'Visit every current travel destination.', 'destinations', 1),
  badge('first-shiny', 'First Shiny', 'Catch your first Shiny creature.', 'shinies', 1),
  badge('shiny-hunter', 'Shiny Hunter', 'Catch 25 Shiny creatures.', 'shinies', 25),
